...
public class syldhaka extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.syldhaka);
	...
	public void onClick2(View view) {
		...
		String alert1 = "Train No: 710";
		String alert2 = "Train Name: Parabat Express";
		String alert3 = "Left Sylhet at 15:10";
		String alert4 = "Next Station: Dhaka";
		String alert5 = "Next Stop: Dhaka at 13th stn";
...
public void onClick3(View view) {
		...
		Builder builder = new Builder(this);
		builder.setTitle("Realtime Location");
		String alert1 = "Train No: 718";
		String alert2 = "Train Name: Jayantika Express";
		String alert3 = "Left Sylhet at 08:20";
		String alert4 = "Next Station: Dhaka";
...
public void onClick4(View view) {
	...
	Builder builder = new Builder(this);
	builder.setTitle("Realtime Location");
	String alert1 = "Train No: 740";
	String alert2 = "Train Name: Upaban Express";
	String alert3 = "Left Sylhet at 22:10";
	String alert4 = "Next Station: Dhaka";
	String alert5 = "Next Stop: Dhaka at 17th stn";
	String alert6 = "Delay: 00:25";
	builder.setMessage(alert1 +"\n"+ alert2 +"\n"+ alert3+"\n"+ alert4+"\n"+ alert5+"\n"+ alert6);
