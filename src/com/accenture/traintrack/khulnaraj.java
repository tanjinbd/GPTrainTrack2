...
public class khulnaraj extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.khulnaraj);
	...
	public void onClick2(View view) {
		...
		String alert1 = "Train No: 715";
		String alert2 = "Train Name: Kapotaksh Express";
		String alert3 = "Left Khulna at 06:30";
		String alert4 = "Next Station: Rajshahi";
		String alert5 = "Next Stop: Rajshahi at 7th stn";
		String alert6 = "Delay: 00:07";
...
public void onClick3(View view) {
		...
		Builder builder = new Builder(this);
		builder.setTitle("Realtime Location");
		String alert1 = "Train No: 761";
		String alert2 = "Train Name: Sagordani Express";
		String alert3 = "Left Khulna at 15:10";
		String alert4 = "Next Station: Rajshahi";
		String alert5 = "Next Stop: Rajshahi at 8th stn";
		String alert6 = "Delay: 00:11";
		builder.setMessage(alert1 +"\n"+ alert2 +"\n"+ alert3+"\n"+ alert4+"\n"+ alert5+"\n"+ alert6);
