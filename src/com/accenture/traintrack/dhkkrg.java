...
public class dhkkrg extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dhkkrg); 
	...
	public void onClick2(View view) {
		...
		String alert1 = "Train No: 737";
		String alert2 = "Train Name: Egarosindhur Provati";
		String alert3 = "Left Dhaka at 7:10";
		String alert4 = "Next Station: Kishorganj";
		String alert5 = "Next Stop: Kishorganj at 13th stn";
...
public void onClick3(View view) {
		...
		Builder builder = new Builder(this);
		builder.setTitle("Realtime Location");
		String alert1 = "Train No: 749";
		String alert2 = "Train Name: Egarosindhur Godhuli";
