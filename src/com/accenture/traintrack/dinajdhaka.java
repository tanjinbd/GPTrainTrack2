...
public class dinajdhaka extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dinajdhaka);
	...
	public void onClick2(View view) {
		...
		String alert1 = "Train No: 706";
		String alert2 = "Train Name: Ekota express";
		String alert3 = "Left Dinajpur at 21:50";
		String alert4 = "Next Station: Dhaka";
		String alert5 = "Next Stop: Dhaka at 8th stn";
...
public void onClick3(View view) {
		...
		Builder builder = new Builder(this);
		builder.setTitle("Realtime Location");
		String alert1 = "Train No: 758";
		String alert2 = "Train Name: Drutojan express";
		String alert3 = "Left Dinajpur at 08:10";
		String alert4 = "Next Station: Dhaka";
		String alert5 = "Next Stop: Dhaka at 7th stn";
		String alert6 = "Delay: 00:16";
		builder.setMessage(alert1 +"\n"+ alert2 +"\n"+ alert3+"\n"+ alert4+"\n"+ alert5+"\n"+ alert6);
