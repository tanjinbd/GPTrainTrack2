...
public class khulnasp extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.khulnasp);
	...
	public void onClick2(View view) {
		...
		String alert1 = "Train No: 727";
		String alert2 = "Train Name: Rupsha Express";
		String alert3 = "Left Khulna at 07:50";
		String alert4 = "Next Station: Saidpur";
		String alert5 = "Next Stop: Saidpur at 2nd stn";
...
public void onClick3(View view) {
		...
		Builder builder = new Builder(this);
		builder.setTitle("Realtime Location");
		String alert1 = "Train No: 747";
		String alert2 = "Train Name: Simanta Express";
		String alert3 = "Left Khulna at 20:45";
		String alert4 = "Next Station: Saidpur";
		String alert5 = "Next Stop: Saidpur at 8th stn";
		String alert6 = "Delay: 00:13";
		builder.setMessage(alert1 +"\n"+ alert2 +"\n"+ alert3+"\n"+ alert4+"\n"+ alert5+"\n"+ alert6);
