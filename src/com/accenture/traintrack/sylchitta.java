...
public class sylchitta extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.sylchitta);
	...
	public void onClick2(View view) {
		...
		String alert1 = "Train No: 720";
		String alert2 = "Train Name: Paharika Express";
		String alert3 = "Left Sylhet at 10:15";
...
public void onClick3(View view) {
		...
		Builder builder = new Builder(this);
		builder.setTitle("Realtime Location");
		String alert1 = "Train No: 724";
		String alert2 = "Train Name: Udayan Express";
		String alert3 = "Left Sylhet at 21:20";
		String alert4 = "Next Station: Bhatshala";
		String alert5 = "Next Stop: Chittagong at 37th stn";
