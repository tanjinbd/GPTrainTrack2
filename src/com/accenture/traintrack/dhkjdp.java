...
public class dhkjdp extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dhkjdp);
	...
	public void onClick2(View view) {
		...
		String alert1 = "Train No: Turag/1";
		String alert2 = "Train Name: Turag/1 express";
		String alert3 = "Left Dhaka at 15:10";
		String alert4 = "Next Station: Joydebpur";
		String alert5 = "Next Stop: Joydebpur at 3rd stn";
		String alert6 = "Delay: 00:2";
...
public void onClick3(View view) {
		...
		Builder builder = new Builder(this);
		builder.setTitle("Realtime Location");
		String alert1 = "Train No: Turag/7";
		String alert2 = "Train Name: Turag/7 express";
