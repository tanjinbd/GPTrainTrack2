...
public class dhaka extends Activity  {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Spinner spinner1 = (Spinner)findViewById(R.id.dhaka);
    ...
    private class SpinnerHandler implements OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> spinner, View selectedView, 
             ...
             if(spinner.getItemAtPosition(selectedIndex).toString().equals("Dinajpur")) {
             Intent i = new Intent(getApplicationContext(),dhkdnj.class);
             startActivity(i);
            }
            //Toast for test 
            //Toast.makeText(spinner.getContext(), spinner.getItemAtPosition(selectedIndex).toString() + " selected ", Toast.LENGTH_LONG).show();
        }
